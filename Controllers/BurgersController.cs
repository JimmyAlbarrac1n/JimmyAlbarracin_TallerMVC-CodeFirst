...
namespace JimmyAlbarracin_TallerMVC_CodeFirst.Controllers
{
    public class BurgersController : Controller
    {
        private readonly JimmyAlbarracin_TallerMVC_CodeFirstContext _context;

        public BurgersController(JimmyAlbarracin_TallerMVC_CodeFirstContext context)
        {
            _context = context;
        }
